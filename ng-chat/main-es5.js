...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppCompCompComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function CompComponent_s_adam_no_chat_12_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "s-adam-no-chat");
      }
    }

    function CompComponent_s_adam_direct_13_Template(rf, ctx) {
      if (rf & 1) {
        var _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "s-adam-direct", 13);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("clickOnUsername", function CompComponent_s_adam_direct_13_Template_s_adam_direct_clickOnUsername_0_listener($event) {
    ...
    function CompComponent_div_14_Template(rf, ctx) {
      if (rf & 1) {
    ...
    CompComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 15,
      vars: 7,
      consts: [[1, "container"], [1, "row"], [1, "col-1"], ["routerLink", "/mobile/"], [3, "logo", "navItems"], [1, "col-3"], [3, "dialogs", "clickToLink"], [3, "dialogs"], [1, "col"], [1, "chat"], [4, "ngIf"], [3, "message", "clickOnUsername", 4, "ngIf"], ["class", "col-3", 4, "ngIf"], [3, "message", "clickOnUsername"]],
      template: function CompComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("clickToLink", function CompComponent_Template_s_adam_contacts_clickToLink_8_listener($event) {

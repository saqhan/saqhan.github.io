...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["mobile-mobile-module"], {
  ...
  function srcAppChatNavigateServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ChatNavigateService = /*#__PURE__*/function () {
      ...
      _createClass(ChatNavigateService, [{
        ...
        key: "controlChatFolders",
        value: function controlChatFolders(id, open) {
          this.router.navigate(["/chat/".concat(id)], {
            queryParams: {
  ...
  function srcAppMobileResViewMobilePersonalChatMobilePersonalChatComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function MobilePersonalChatComponent_s_adam_profile_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("clickToShowDialogs", function MobilePersonalChatComponent_s_adam_profile_2_Template_s_adam_profile_clickToShowDialogs_0_listener() {
          ...
          return ctx_r15.clickToShowFolders();
        });
    ...
    var MobilePersonalChatComponent = /*#__PURE__*/function () {
      ...
      _createClass(MobilePersonalChatComponent, [{
        ...
        key: "clickToShowFolders",
        value: function clickToShowFolders() {
          this.animSRVC.slideToLEFT();
        ...
        key: "showFolders",
        value: function showFolders(open) {
  ...
  function srcAppMobileResViewUserProfileUserProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    UserProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 0,
      consts: [[3, "onClickToShowFolders", "clickToShowDialogs"]],
      template: function UserProfileComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "adam-profile", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onClickToShowFolders", function UserProfileComponent_Template_adam_profile_onClickToShowFolders_0_listener() {
            return ctx.clickToShowFolders();
          })("clickToShowDialogs", function UserProfileComponent_Template_adam_profile_clickToShowDialogs_0_listener($event) {
